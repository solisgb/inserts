...
class Upsert_ipas_ipa2():

    column_names = {'cod': None, 'fecha': None, 'situacion': None, 'pnp': None,
                    'instalado': None, 'tuboguia': None, 'tr': None,
                    'proyecto': None, 'codigosonda': None, 'medidor': None}
    ...
    @property
    def instalado(self):
        return self.col_names['instalado']


    @property
    def tuboguia(self):
        return self.col_names['tuboguia']
    ...
    @property
    def codigosonda(self):
        return self.col_names['codigosonda']
    ...
    def upsert(self, update: bool=True, check: bool=True) ->None:
        ...
        insert = \
        """
        insert into ipas.ipa2 (cod, fecha, situacion, pnp, instalado,
                               tuboguia, tr, proyecto, codigosonda,
                               medidor, pnp_original)
        values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);
        """
        update = \
        """
        update ipas.ipa2
        set situacion=%s, pnp=%s, instalado=%s, tuboguia=%s, tr=%s,
            proyecto=%s, codigosonda=%s, medidor=%s, pnp_original=%s
                ...
                try:
                    cur.execute(insert,
                                (row[self.cod], row[self.fecha],
                                 row[self.situacion], row[self.pnp],
                                 row[self.instalado], row[self.tuboguia],
                                 row[self.tr], row[self.proyecto],
                                 row[self.codigosonda], row[self.medidor],
                                 row[self.pnp]))
